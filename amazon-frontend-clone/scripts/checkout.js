...
// Get the "Place your order" button and thank you message container
const placeOrderButton = document.querySelector('.place-order-button');
const thankYouMessageContainer = document.querySelector('.thank-you-message-container');

// Add an event listener to the "Place your order" button
placeOrderButton.addEventListener('click', function () {
    // Hide the checkout page content
